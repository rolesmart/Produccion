...
class SaleReport(models.Model):
    ...
    def _select_additional_fields(self):
        ...
        res['ciudad'] = "s.ciudad"
        res['categoria'] = "partner.categoria"
    ...
    def _group_by_sale(self):
        ...
        res += """, l.precio_promedio, s.ciudad, partner.categoria, sol01.p_producto_30, sol01.p_producto_60, sol01.p_producto_90, sol02.p_producto_cty_30, sol02.p_producto_cty_60, \
